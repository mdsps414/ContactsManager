...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration{
    ...
    private StickyHeaderInterface mAdapter;

    private boolean mRenderInline;

    public StickyHeaderDecoration(StickyHeaderInterface adapter) {
        this(adapter, false);
    }

    public StickyHeaderDecoration(StickyHeaderInterface adapter, boolean renderInline) {
        mAdapter = adapter;
