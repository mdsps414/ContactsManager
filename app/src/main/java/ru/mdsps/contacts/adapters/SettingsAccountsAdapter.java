...
public class SettingsAccountsAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = null;
        if(convertView == null){
            v = View.inflate(mContext, R.layout.settings_item_contact_account, null);
        } else {
            v = convertView;
        }
        ...
        acc_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(acc_check.isChecked()) {
                    mListener.onElementClick(mListener.SETTINGS_LISTENER_ACCOUNT_SHOW, v);
                } else {
                    mListener.onElementClick(mListener.SETTINGS_LISTENER_ACCOUNT_HIDE, v);
                }
            }
        });
